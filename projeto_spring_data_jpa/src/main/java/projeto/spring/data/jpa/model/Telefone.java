...
@Entity // Usamos a anotacao entity para que telefone se torne uma classe persistente no
		// banco de dados
public class Telefone {
	...
	@ManyToOne(optional = false) // uma pessoa pode ter muitos telefones por isso usamos a anotacao manyToOne
